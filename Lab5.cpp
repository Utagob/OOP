...
class Cont{
    ...
    public:
        ...
        void depuneBani(float suma){
            ...
            string s;
            s = "Depunere bani -> suma: " + to_string(suma);
        ...
        void retrageBani(float suma){
            if(suma <= sold){
                ...
                string s;
                s = "Retragere bani -> suma: " + to_string(suma);
                tranzactie.push_back(s);
            } else {
        ...
        void trimiteBani(int idDestinatie, vector<Cont> &C){
            for(int i=0; i<C.size(); i++){
                if(idDestinatie == C[i].getID()){
                    ...
                    if(suma <= sold){
                        ...
                        string s;
                        s = "Transfer -> persoana: " + C[i].getNume() + " -> suma -> " + to_string(suma);
                        tranzactie.push_back(s);
                    } else {
            ...
            cout << "Error! Nu exista cont cu ID-ul oferit" << endl;
            cout << endl;
        }
...
void interfata(int a, vector<Cont> &C){
    int x;
    do{
        cout << "Detinator: " << C[a].getNume() << endl;
        ...
        switch(x){
            ...
            default: cout << "Nu exista optinunea selectata" << endl;
        }
